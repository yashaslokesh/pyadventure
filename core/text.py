...
class ScrollingText(object):
    ...
    def __init__(self, font, text, color = (255, 255, 255), initial_pos = [50, 400], nl_offset = 50):
        ...
        for line_index, line in enumerate(self.text):
            ...
            for char_index, char in enumerate(words):
                ...
                if char == '>':
                    ...
                    self.backspace_count = int(''.join(words[char_index + 2: char_index + 4]))
                    ...
                    words[char_index:] = ['+'] * self.backspace_count + words[char_index + 5:]
