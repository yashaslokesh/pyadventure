...
# Initialize fonts -------------------------------------------
dpcomic_font = text.load_font(os.path.join('dpcomic','dpcomic.ttf'), size = DPCOMIC_SCROLLING_TEXT_SIZE)
